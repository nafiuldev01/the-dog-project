...
import "./App.css";
import Dog from "./assets/components/Dog";
    ...
    <>
      <main>
        <div className="images">
          ...
          <img id="louis-phone" src="/bg/louis-phone.png" alt="" />
          <img id="kikk-festival" src="/bg/kikk-festival.png" alt="" />
          <img id="kennedy-center" src="/bg/kennedy-center.png" alt="" />
          <img id="royal-opera" src="/bg/royal-opera.png" alt="" />
        </div>
        <Canvas
          id="canvas-elem"
          style={{
        ...
        <section id="section-1">
          ...
          <div className="bottom">
            ...
            <div className="right">
              ...
              <p>Facebook / Instagram / Dribble / Twitter / Newsletter</p>
            </div>
          </div>
          {/* red line */}
